<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <select id="status" name="status" class="mt-1 block w-full form-input rounded-md shadow-sm"
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <select id="language" name="language" class="mt-1 block w-full form-input rounded-md shadow-sm"
