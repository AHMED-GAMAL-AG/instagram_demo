<div class="min-h-screen flex flex-row sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100">
    <div>
        ...
        <img src="images/icon.png" alt="logo" srcset="" class="xl:w-80 xl:h-80 md:w-64 md:h-64 mr-12 w-12 h-0 ">
    </div>
    ...
    <div class="flex flex-col">
        ...
        @if (str_contains(url()->current(), 'login'))
            <div
                ...
                <span class="text-sm text-gray-600 pr-5">{{ __('Don\'t have an account?') }}<a
                        href="{{ route('register') }}"
